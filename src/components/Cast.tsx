    ...
    <>
      <section className="mb-6 scroll-mt-12" id="cast">
        ...
        {castResponse.cast.length > 0 ? (
          ...
          <EmptyState
            title="Oops!"
            description="Seems we can't find any cast related to this media"
          />
        )}
      </section>
      ...
      <section id="crew" className="scroll-mt-10">
        ...
        {castResponse.crew.length > 0 ? (
          ...
          <EmptyState
            title="Oops!"
            description="Seems we can't find any crew related to this media"
          />
        )}
      </section>
    </>
